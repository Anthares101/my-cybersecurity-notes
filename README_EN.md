...
- **Burpsuite (or OWASP ZAP):** Captures all browser requests and allows editing them. The repeater module of this proxy allows us to send and receive headers as if we were the browser going (the ones we want)
