...
- **Burpsuite (o OWASP ZAP):** Captura todas las peticiones del navegador y permite su edicion. El módulo repeater permite ir mandando y recibiendo cabeceras como si fuesemos el navegador vaya (las que queramos)
